...
| `server/services/living-weapon.service.ts` | Living Weapon wield state — engageLivingWeapon, disengageLivingWeapon, findWieldRelationship, isWielded, isWielding, getWieldedWeapon, getWielder, updateWieldFaintedState, clearWieldOnRemoval, meetsSkillRequirement |
