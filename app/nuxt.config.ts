...
export default defineNuxtConfig({
  ...
  css: ['~/assets/scss/main.scss', '~/assets/scss/_create-form.scss', '~/assets/scss/components/_create-form-shared.scss', '~/assets/scss/components/_player-view.scss', '~/assets/scss/components/_player-combat-actions.scss'],
