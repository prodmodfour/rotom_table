...
- **`encounter.ts` is ~1443 lines**: Largest store, well above the 800-line guideline. ISP extraction of `encounterCombat`, `encounterGrid`, and `encounterXp` reduced it from even larger, but further extraction may be needed.
