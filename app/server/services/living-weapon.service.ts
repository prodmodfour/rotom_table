...
// Re-export functions extracted to sub-services (C1 split)
export {
  syncWeaponPosition,
  handleLinkedMovement,
  getWieldedMovementSpeed,
  resetWieldMovementPools,
} from '~/server/services/living-weapon-movement.service'

export {
  isNoGuardActive,
  targetHasNoGuard,
  swapAegislashStance,
  isAegislashBladeForm,
  canUseWeaponize,
  checkSoulstealer,
  applySoulstealerHealing,
} from '~/server/services/living-weapon-abilities.service'
