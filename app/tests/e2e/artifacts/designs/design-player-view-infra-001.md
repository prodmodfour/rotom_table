...
| **Verdict** | Best security. But requires ALL players to install Tailscale -- friction too high for casual group | **Best overall.** Zero player friction, free, persistent URL, WebSocket support, auto-HTTPS | Viable but costly for persistence. Free tier too limited (2h, interstitial) | Not viable -- requires self-hosting a relay, too technical |
