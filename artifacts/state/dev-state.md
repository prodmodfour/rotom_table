---
last_updated: 2026-03-04T12:25:00
updated_by: slave-collector (plan-20260304-115403)
---
...
| ptu-rule-131 | P3 | **APPROVED** | Poke Ball accuracy check should use central calculateAccuracyThreshold utility per decree-042. Implemented by slave-2 (plan-20260303-202535): 7 commits. Reviewed by slave-4 (plan-20260304-000900): code-review-312 **CHANGES_REQUIRED** + rules-review-285 **CHANGES_REQUIRED**. Fix cycle by slave-1 (plan-20260304-012646): 5 commits. Re-reviewed by slave-3 (plan-20260304-085746): code-review-315 **APPROVED** + rules-review-288 **APPROVED**. All issues resolved. Feature complete |
...
| feature-005 | P3 | **P2-CHANGES_REQUIRED** | Living Weapon System (Honedge Line) — P0 APPROVED (code-review-301 + rules-review-274). P1 APPROVED (code-review-319 + rules-review-292). P2 reviewed: code-review-321 **CHANGES_REQUIRED** (1C+3H+3M: service over 800 lines, movementUsedThisRound not persisted, resetWieldMovementPools never called, No Guard not suppressed client-side) + rules-review-294 **CHANGES_REQUIRED** (2H+3M: movement pool never resets, Soulstealer scene frequency not enforced). **P2 needs fix cycle** | multi-phase |
...
| feature-024 | P3 | **implemented** | Living Weapon unit test coverage — engage validation, disengage clearing, state reconstruction, homebrew fallback, getLivingWeaponConfig. Implemented by slave-4 (plan-20260304-115403): 4 commits, 3 test files (living-weapon.service.test.ts, living-weapon-state.test.ts, combatantCapabilities.test.ts). **Needs review** | single-phase |
...
| ux-012 | P3 | **CHANGES_REQUIRED** | Client-side status_tick WebSocket handler for tick damage notifications. Implemented by slave-4 (plan-20260304-110950). Reviewed: code-review-322 **CHANGES_REQUIRED** (1C: single ref overwrites on multi-tick turns, 2M: dropped payload fields, wrong commit hashes) + rules-review-295 **APPROVED** (all tick mechanics correct, decree-032 compliant). **Needs fix cycle** |
...
**Current task:** Session 108 collection complete. 4 slaves merged (9 commits), 0 skipped. 3 reviewer slaves + 1 dev slave.

**Session 108 (2026-03-04, plan-20260304-115403):**
- **slave-1** (reviewers): feature-005-p2-review — code-review-321 **CHANGES_REQUIRED** (1C+3H+3M) + rules-review-294 **CHANGES_REQUIRED** (2H+3M). Also filed decree-need-045. → feature-005 **P2-CHANGES_REQUIRED, needs fix cycle**
- **slave-2** (reviewers): ux-012-review — code-review-322 **CHANGES_REQUIRED** (1C+2M) + rules-review-295 **APPROVED**. → ux-012 **CHANGES_REQUIRED, needs fix cycle**
- **slave-3** (reviewers): refactoring-114-review — code-review-323 **APPROVED** (0 issues). → refactoring-114 **APPROVED, feature complete**
- **slave-4** (developer): feature-024 — 4 commits: Living Weapon unit tests (3 test files: living-weapon.service.test.ts, living-weapon-state.test.ts, combatantCapabilities.test.ts). → **implemented, needs review**

**Smoke test:** PASSED (all 3 views render correctly)
**Tickets APPROVED:** refactoring-114 (code-review-323 APPROVED — pure rename, feature complete)
**Tickets needing fix cycle:** feature-005 P2 (code-review-321 1C+3H+3M + rules-review-294 2H+3M), ux-012 (code-review-322 1C+2M)
**New implementations needing review:** feature-024 (Living Weapon unit tests)
**Decree-need filed:** decree-need-045 (No Guard ability definition: core vs playtest)
...
- **slave-2** (reviewers): feature-005-p1-rereview — code-review-319 **APPROVED** (1M: calculate-damage.post.ts missing moveKeywords → bug-050) + rules-review-292 **APPROVED** (all 6 issues resolved, 0 regressions). → feature-005 **P1-APPROVED, ready for P2**

**Smoke test:** PASSED (all 3 views render correctly)
**Tickets APPROVED:** feature-005 P1 (both re-reviews passed — P1 complete, ready for P2)
**Tickets needing re-review:** feature-018 P2 (fix cycle done)
**Tickets filed:** bug-050 (moveKeywords passthrough, from code-review-319 M1)

**Session 105 (2026-03-04, plan-20260304-095500):**
- **slave-1** (developer): refactoring-127 — 11 commits: Rename project from "PTU Session Helper" to "Rotom Table". Updated package.json, nuxt.config.ts, page titles, layout headers, SCSS comments, README, remote access docs. → **completed**
- **slave-2** (developer): feature-005-p1-fix — 7 commits: Fix cycle addressing code-review-316 + rules-review-289. Small Melee +1 DB modifier applied to Living Weapon moves (rules H1), STAB skipped for Weapon keyword moves (rules M1), getEffectiveEquipBonuses extracted to shared utility (code M1), weapon moves injected into GM move selection UI (code H1), wielder evasion restored on encounter reload (rules M2), app-surface.md updated (code M2), ticket+log updated. → **fix-cycle-done, needs re-review**
- **slave-3** (reviewers): feature-018-p2-review — code-review-317 **CHANGES_REQUIRED** (1H: server-side Thermosensitive movement halving missing for mount speed, 3M: Sand Force clamp ordering divergence, app-surface.md, WeatherEffectIndicator imports server service) + rules-review-290 **APPROVED** (2M non-blocking: Leaf Guard scope narrowed, server mount movement weather gap). → feature-018 **P2-CHANGES_REQUIRED, needs fix cycle**
- **slave-4** (reviewers): feature-004-p2-rereview — code-review-318 **APPROVED** (all code-review-314 1C+2H+3M + rules-review-287 1H+1M issues verified resolved, 0 new) + rules-review-291 **APPROVED** (10 mechanics verified, decree-003/004/040 compliant). → feature-004 **P2-APPROVED, feature complete**

**Smoke test:** PASSED (all 3 views render — "Rotom Table" branding confirmed)
**Tickets APPROVED:** feature-004 P2 (both re-reviews passed — feature complete)
**Tickets needing fix cycle:** feature-018 P2 (code-review-317 1H+3M), feature-005 P1 (fix done, needs re-review)
**Tickets completed:** refactoring-127 (project rename to Rotom Table)
...
### Session 108 Reviews (plan-20260304-115403)
| Review ID | Target | Verdict | Reviewer | Date |
|-----------|--------|---------|----------|------|
| code-review-321 | feature-005 P2 first review (Living Weapon P2: 14 commits, Sections J-N) | CHANGES_REQUIRED (1C: living-weapon.service.ts over 800 lines, 3H: movementUsedThisRound not persisted, resetWieldMovementPools never called, No Guard not suppressed client-side, 3M: direct mutation, Soulstealer mutation inconsistency, Soulstealer scene frequency not enforced) | senior-reviewer | 2026-03-04 |
| rules-review-294 | feature-005 P2 first review (Living Weapon P2: 8 mechanics verified) | CHANGES_REQUIRED (2H: movement pool never resets at round start, Soulstealer scene frequency not enforced. 3M: No Guard client-side gap, shared pool ignores movement modifiers, No Guard definition needs decree) | game-logic-reviewer | 2026-03-04 |
| code-review-322 | ux-012 first review (status_tick WebSocket handler: 3 commits) | CHANGES_REQUIRED (1C: single ref overwrites when multiple ticks fire in one turn, 2M: handler drops combatantId/formula from payload, wrong commit hashes in resolution log) | senior-reviewer | 2026-03-04 |
| rules-review-295 | ux-012 first review (status_tick handler: 5 mechanics verified) | APPROVED (all tick mechanics correct: Burn/Poison/Cursed/weather. decree-032 compliant. 1M non-blocking: lastStatusTick single-ref overwrite) | game-logic-reviewer | 2026-03-04 |
| code-review-323 | refactoring-114 (capturedSpecies → ownedSpecies rename: 4 commits, 10 source files) | APPROVED (0 issues. Complete rename, correct @map technique, zero stale references, clean commit layering) | senior-reviewer | 2026-03-04 |
...
| Review ID | Target | Verdict | Reviewer | Date |
|-----------|--------|---------|----------|------|
| code-review-319 | feature-005 P1 re-review (Living Weapon Equipment Integration fix cycle: 7 commits) | APPROVED (all 6 code-review-316 + rules-review-289 issues resolved, 1M new: calculate-damage.post.ts missing moveKeywords passthrough → bug-050) | senior-reviewer | 2026-03-04 |
| rules-review-292 | feature-005 P1 re-review (Living Weapon Equipment Integration fix cycle: 5 mechanics verified) | APPROVED (all 6 issues resolved, 0 regressions, decree-043/044/001 compliant) | game-logic-reviewer | 2026-03-04 |

### Session 105 Reviews (plan-20260304-095500)
| Review ID | Target | Verdict | Reviewer | Date |
|-----------|--------|---------|----------|------|
| code-review-317 | feature-018 P2 first review (Weather Effect Automation P2: 12 commits) | CHANGES_REQUIRED (1H: server-side Thermosensitive movement halving not applied to mounted combatants, 3M: Sand Force min-1 clamp ordering divergence between client/server + app-surface.md not updated + WeatherEffectIndicator imports server-only service) | senior-reviewer | 2026-03-04 |
| rules-review-290 | feature-018 P2 first review (Weather Effect Automation P2: 13 mechanics verified) | APPROVED (2M non-blocking: Leaf Guard scope narrowed to persistent statuses, server-side mount movement missing weather parameter for Thermosensitive. All P2 mechanics produce correct game values. Decree-005/045 compliant) | game-logic-reviewer | 2026-03-04 |
| code-review-318 | feature-004 P2 re-review (Rider Class Features fix cycle: 7 commits) | APPROVED (all code-review-314 1C+2H+3M + rules-review-287 1H+1M issues verified resolved, 0 new. Ride as One evasion in accuracy calc, Agility Training persistent mountState, dead functions wired, typo eliminated) | senior-reviewer | 2026-03-04 |
| rules-review-291 | feature-004 P2 re-review (Rider Class Features fix cycle: 10 mechanics verified) | APPROVED (all issues resolved. applyResistStep full PTU effectiveness ladder correct, decree-003/004/040 compliant) | game-logic-reviewer | 2026-03-04 |

### Session 104 Reviews (plan-20260304-085746)
| Review ID | Target | Verdict | Reviewer | Date |
|-----------|--------|---------|----------|------|
| code-review-315 | ptu-rule-131 re-review (Poke Ball accuracy fix cycle) | APPROVED (all 4 code-review-312 issues resolved, 0 new. Formula parity with move system confirmed, decree-042/040 compliant) | senior-reviewer | 2026-03-04 |
| rules-review-288 | ptu-rule-131 re-review (Poke Ball accuracy fix cycle) | APPROVED (8 mechanics verified, decree-042/040/013 compliant. Single-expression formula identical to useMoveCalculation.ts:443) | game-logic-reviewer | 2026-03-04 |
| code-review-316 | feature-005 P1 first review (Living Weapon Equipment Integration: 11 commits) | CHANGES_REQUIRED (1H: weapon moves not injected into client-side GMActionModal move list, 2M: useMoveCalculation.ts 806 lines → refactoring-128 + app-surface.md not updated for P1 exports) | senior-reviewer | 2026-03-04 |
| rules-review-289 | feature-005 P1 first review (Living Weapon Equipment Integration: 12 mechanics verified) | CHANGES_REQUIRED (1H: weapon move DB values missing Small Melee Weapon +1 modifier per PTU p.287, 2M: STAB exclusion for [Weapon] keyword moves not enforced + evasion cache stale on encounter reload with active wield relationships) | game-logic-reviewer | 2026-03-04 |

### Session 103 Reviews (plan-20260304-012646)
| Review ID | Target | Verdict | Reviewer | Date |
|-----------|--------|---------|----------|------|
| code-review-313 | feature-018 P1 re-review (Weather Effect Automation fix cycle) | APPROVED (all 3 code-review-310 issues resolved, 0 new. Client-side weather DB modifier correct, WebSocket broadcast sends actual newHp/fainted, Desert Weather deferred to P2) | senior-reviewer | 2026-03-04 |
| rules-review-286 | feature-018 P1 re-review (Weather Effect Automation fix cycle) | APPROVED (5 mechanics verified, decree-045 compliant. Rain/Sun +/-5 DB correct, Sun Blanket 1/10th correct) | game-logic-reviewer | 2026-03-04 |
| code-review-314 | feature-004 P2 first review (Rider Class Features: 14 commits, 7 features) | CHANGES_REQUIRED (1C: Ride as One evasion sharing ineffective for accuracy calc — calculate-damage.post.ts recalculates from scratch, 2H: Agility Training tempCondition auto-cleared at turn end + 5 dead utility functions, 3M: ConquerorsMarsh typo + app-surface.md + direct turnState mutation in component) | senior-reviewer | 2026-03-04 |
| rules-review-287 | feature-004 P2 first review (Rider Class Features: 16 mechanics verified) | CHANGES_REQUIRED (1H: Lean In applyResistStep skips step for 2.0x — Doubly SE should go to 1.5x not 1.0x, 1M: ConquerorsMarsh typo. 14 other mechanics correct, decree-003/004/040 compliant) | game-logic-reviewer | 2026-03-04 |
...
## Session Summary (2026-03-04, session 108 — plan-20260304-115403)

**Slave collection plan-20260304-115403:** 4 slaves merged (9 commits total). 3 reviewer slaves + 1 dev slave, all completed successfully.
- **slave-1** (reviewers): feature-005-p2-review — code-review-321 **CHANGES_REQUIRED** (1C+3H+3M) + rules-review-294 **CHANGES_REQUIRED** (2H+3M). decree-need-045 filed.
- **slave-2** (reviewers): ux-012-review — code-review-322 **CHANGES_REQUIRED** (1C+2M) + rules-review-295 **APPROVED** (1M non-blocking)
- **slave-3** (reviewers): refactoring-114-review — code-review-323 **APPROVED** (0 issues)
- **slave-4** (developer): feature-024 — 4 commits (3 Living Weapon test files: service, state, capabilities)

**Smoke test:** PASSED (all 3 views render correctly)
**Tickets APPROVED:** refactoring-114 (code-review-323 — pure rename, feature complete)
**Tickets needing fix cycle:** feature-005 P2 (1C+3H+3M code + 2H+3M rules), ux-012 (1C+2M code)
**New implementations needing review:** feature-024 (Living Weapon unit tests)
**Decree-need filed:** decree-need-045 (No Guard definition: core vs playtest)
**CLAUDE.md updates:** 1 (app/tests/CLAUDE.md — services 7→9 files, total 53→55)
...
**Slave collection plan-20260304-104014:** 2 slaves merged (7 commits total). 1 dev slave + 1 reviewer slave, all completed successfully.
- **slave-1** (developer): feature-018-p2-fix — 5 commits (server-side weather threading for mount speed, Sand Force clamp reordering, WEATHER_ABILITY_EFFECTS moved to client utils, app-surface.md, ticket update)
- **slave-2** (reviewers): feature-005-p1-rereview — code-review-319 **APPROVED** (1M: moveKeywords passthrough → bug-050) + rules-review-292 **APPROVED** (0 issues)

**Smoke test:** PASSED (all 3 views render correctly)
**Tickets APPROVED:** 1 (feature-005 P1 — both re-reviews passed, P1 complete, ready for P2)
**Tickets needing re-review:** feature-018 P2 (fix cycle done)
**Tickets filed:** 1 (bug-050: moveKeywords passthrough from code-review-319 M1)
**CLAUDE.md updates:** 1 (app/server/services/CLAUDE.md — weather-automation line count ~222→~192, noted constant relocation)

## Session Summary (2026-03-04, session 105 — plan-20260304-095500)

**Slave collection plan-20260304-095500:** 4 slaves merged (21 commits total). 2 dev slaves + 2 reviewer slaves, all completed successfully.
- **slave-1** (developer): refactoring-127 — 11 commits (project rename from "PTU Session Helper" to "Rotom Table": package.json, nuxt.config.ts, page titles, layout headers, SCSS, README, docs)
- **slave-2** (developer): feature-005-p1-fix — 7 commits (Small Melee +1 DB modifier, STAB weapon exclusion, getEffectiveEquipBonuses extraction, GM move UI injection, encounter reload evasion restore, app-surface.md)
- **slave-3** (reviewers): feature-018-p2 review — code-review-317 **CHANGES_REQUIRED** (1H+3M) + rules-review-290 **APPROVED** (2M non-blocking)
- **slave-4** (reviewers): feature-004-p2 re-review — code-review-318 **APPROVED** + rules-review-291 **APPROVED** → **feature-004 P2 feature complete**

**Smoke test:** PASSED (all 3 views render with "Rotom Table" branding)
**Tickets APPROVED:** 1 (feature-004 P2 — both re-reviews passed, feature complete)
**Tickets needing fix cycle:** 1 (feature-018 P2 — code-review-317 1H+3M)
**Tickets needing re-review:** feature-005 P1 (fix cycle done)
**Tickets completed:** refactoring-127 (project rename)

## Session Summary (2026-03-04, session 104 — plan-20260304-085746)

**Slave collection plan-20260304-085746:** 4 slaves merged (23 commits total). 2 dev slaves + 2 reviewer slaves, all completed successfully.
- **slave-1** (developer): feature-018-p2 — 12 commits (Weather Ball type/DB override, Forecast type change, WeatherEffectIndicator component, Sand Force damage, Hydration/Leaf Guard cure, Snow Cloak/Sand Veil evasion, Thermosensitive movement, weather tooltip)
- **slave-2** (developer): feature-004-p2-fix — 7 commits (applyResistStep full ladder, ConquerorsMarsh typo, Agility Training persistent flag, Ride as One accuracy integration, dead functions wired, app-surface.md)
- **slave-3** (reviewers): ptu-rule-131 re-review — code-review-315 **APPROVED** + rules-review-288 **APPROVED** → **ptu-rule-131 feature complete**
- **slave-4** (reviewers): feature-005 P1 review — code-review-316 **CHANGES_REQUIRED** (1H+2M) + rules-review-289 **CHANGES_REQUIRED** (1H+2M)

**Smoke test:** PASSED (all 3 views render)
**Tickets APPROVED:** 1 (ptu-rule-131 — both re-reviews passed, feature complete)
**Tickets needing fix cycle:** 1 (feature-005 P1 — code-review-316 1H+2M + rules-review-289 1H+2M)
**Tickets needing re-review:** feature-004 P2 (fix cycle done)
**New implementations needing review:** feature-018 P2 (Weather Effect Automation)
**Tickets filed:** refactoring-128 (useMoveCalculation.ts 806 lines, code-review-316 MED-001)
**CLAUDE.md updates:** 5 files (app/components/encounter/CLAUDE.md — 36 components + WeatherEffectIndicator category, app/composables/CLAUDE.md — useMoveCalculation size + weatherRules dependency, app/stores/CLAUDE.md — encounter.ts ~1620 lines, app/types/CLAUDE.md — combat.ts 321 + encounter.ts 237 lines, CLAUDE.md root — 154 components)

## Session Summary (2026-03-04, session 103 — plan-20260304-012646)

**Slave collection plan-20260304-012646:** 4 slaves merged (22 commits total). 2 dev slaves + 2 reviewer slaves, all completed successfully.
- **slave-1** (developer): ptu-rule-131 fix — 5 commits (eliminated double Math.max clamping, corrected misleading comment, added server trust rationale, clarified doc, updated resolution log)
- **slave-2** (reviewers): feature-018 P1 re-review — code-review-313 **APPROVED** + rules-review-286 **APPROVED** → **feature-018 P1 complete, ready for P2**
- **slave-3** (reviewers): feature-004 P2 review — code-review-314 **CHANGES_REQUIRED** (1C+2H+3M) + rules-review-287 **CHANGES_REQUIRED** (1H+1M)
- **slave-4** (developer): feature-005 P1 — 13 commits (equipment overlay, dual-wield evasion, shield DR, fainted penalty, weapon moves, integration points)

**Smoke test:** PASSED (all 3 views render)
**Tickets APPROVED:** 1 (feature-018 P1 — both re-reviews passed, ready for P2)
**Tickets needing fix cycle:** 1 (feature-004 P2 — code-review-314 1C+2H+3M + rules-review-287 1H+1M)
**Tickets needing re-review:** ptu-rule-131 (fix cycle done)
**New implementations needing review:** feature-005 P1 (Living Weapon equipment integration)
**CLAUDE.md updates:** 3 files (app/composables/CLAUDE.md — useMoveCalculation size, app/server/services/CLAUDE.md — living-weapon.service.ts line count + largest hybrid gotcha, artifacts/CLAUDE.md — design count)
