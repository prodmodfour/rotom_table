---
last_updated: 2026-03-01T09:20:00
updated_by: slave-collector (plan-20260301-084803)
---
...
| feature-006 | P1 | **P1-done** | Pokemon Evolution System — P0 APPROVED. P1 implemented by slave-2 (plan-20260301-084803): 9 commits — remapAbilities(), getEvolutionMoves(), extended performEvolution/evolve endpoint/evolution-check endpoint, multi-step evolution modal (stat/ability/move/summary), WS broadcast. Needs P1 review | multi-phase |
| feature-007 | P1 | **P0-APPROVED** | Pokemon Level-Up Allocation UI — P0 fix cycle APPROVED. code-review-234 **APPROVED** + rules-review-210 **APPROVED** (re-review by slave-4, plan-20260301-084803). All 5 code-review-229 issues resolved. P1 pending | multi-phase |
| feature-008 | P1 | **P0-APPROVED** | Trainer Level-Up Milestone Workflow — P0 fix cycle + decree-037 compliance APPROVED. code-review-235 **APPROVED** + rules-review-211 **APPROVED** (re-review by slave-5, plan-20260301-084803). All 6 code-review-230 + 1 rules-review-206 issues resolved. P1 pending (edges, features, class selection) | multi-phase |
...
| feature-011 | P1 | **P0-fix-cycle-done** | Pokemon Switching Workflow — P0 fix cycle completed by slave-1 (plan-20260301-084803). 8 commits: Trapped check (CRITICAL-001), RECALL_CLEARED_CONDITIONS constant, volatile/tempHP/stages clearing on recall (HIGH-001+002), WS handler (C1), undo+broadcast (H1+H2), switch button logic (M1+M3), Whirlwind comment fix (M1+M2). Needs re-review | multi-phase |
