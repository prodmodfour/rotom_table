---
last_updated: 2026-03-01T16:35:00
updated_by: slave-collector (plan-20260301-152500)
---
...
| ptu-rule-131 | P2 | **open** | Expert+ Combat skill not handled for AoO Struggle Attacks — hardcoded AC 4 / DB 4 should be AC 3 / DB 5 for Expert+ Combat. Source: rules-review-227 (carried from rules-review-223 M1). Filed by slave-collector (plan-20260301-152500) |
...
| feature-006 | P1 | **P2-fix-cycle-done** | Pokemon Evolution System — P0 APPROVED. P1 APPROVED. P2 fix cycle by slave-1 (plan-20260301-152500): 6 commits — PokemonSnapshot notes+consumedStone (C1), Learn/Male/Female seed parser keywords (C1-rules), combined DB transaction (H1), GM override for missing stone (H3), app-surface.md (M1), ticket/design updates. All code-review-248 + rules-review-224 issues resolved. Needs re-review | multi-phase |
| feature-007 | P1 | **P1-APPROVED** | Pokemon Level-Up Allocation UI — P0 APPROVED. P1 fix cycle APPROVED: code-review-243 **APPROVED** (M1: loose MoveDetail types → refactoring-109, M2: canAssignAbility UX → refactoring-110) + rules-review-219 **APPROVED** (all 9 mechanics verified, 0 issues). All code-review-238 + rules-review-214 issues resolved. P2 pending | multi-phase |
| feature-008 | P1 | **P1-APPROVED** | Trainer Level-Up Milestone Workflow — P0 APPROVED. P1 fix cycle APPROVED: code-review-244 **APPROVED** (0 issues) + rules-review-220 **APPROVED** (12 mechanics verified, all 4 decrees compliant, 0 issues). All code-review-239 + rules-review-215 issues resolved. P2 pending | multi-phase |
...
| feature-011 | P1 | **P2-fix-cycle-done** | Pokemon Switching Workflow — P0 APPROVED. P1 APPROVED. P2 fix cycle by slave-2 (plan-20260301-152500): 6 commits — WS handlers for pokemon_recalled/released (CRIT-001), extracted applyRecallSideEffects (M2), turn validation on recall/release (H2), grid-wide fallback placement (M3), app-surface.md (H1), ticket updates. All code-review-249 issues resolved (except M1→refactoring-112). Needs re-review | multi-phase |
...
| feature-009 | P1 | **P0-APPROVED** | Trainer XP & Advancement Tracking — P0 APPROVED. Fix cycle resolved all code-review-246 issues. Re-review by slave-5 (plan-20260301-152500): code-review-253 **APPROVED** + rules-review-229 **APPROVED**. P1 pending | multi-phase |
| feature-013 | P1 | **P1-needs-fix-cycle** | Multi-Tile Token System — P0 APPROVED. P1 implemented. Reviewed by slave-4 (plan-20260301-152500): code-review-250 **CHANGES_REQUIRED** (CRIT-1: movement range not passing tokenSize/gridBounds, HIGH-1/2/3: terrain cost getter not footprint-aware + validateMovement not multi-cell, MED-1: revealFootprintArea not wired, MED-2: empty test case). rules-review-226 **CHANGES_REQUIRED** (CRIT-1: double-footprint terrain cost, HIGH-1: movement range, MED-1: getAveragedSpeedForPath, MED-2: revealFootprintArea). Needs fix cycle | multi-phase |
| feature-014 | P1 | **P0-implemented** | VTT Flanking Detection — P0 implemented by slave-3 (plan-20260301-152500): 9 commits — FlankingStatus/FlankingMap/FlankingSize types (Section A), flankingGeometry.ts pure utility (Section A), useFlankingDetection composable (Section B), drawFlankingIndicator in useCanvasDrawing (Section C), flanking highlights in useGridRendering (Section C), vtt-token--flanked CSS class (Section C), flanking evasion penalty in useMoveCalculation (Section D), wired into MoveTargetModal, ticket/design updates. Needs review. P1 depends on feature-013 | multi-phase |
| feature-016 | P2 | **P0-APPROVED** | Priority / Interrupt / Attack of Opportunity System — P0 APPROVED. Fix cycle resolved all code-review-247 issues. Re-review by slave-6 (plan-20260301-152500): code-review-251 **APPROVED** + rules-review-227 **APPROVED**. P1 pending | multi-phase |
...
**Current task:** Session 76 collection complete. 7 slaves merged (29 commits). 3 dev slaves (feature-006-p2-fix 6 commits, feature-011-p2-fix 6 commits, feature-014-p0 9 commits). 4 reviewer slaves (feature-013-p1-review CHANGES_REQUIRED, feature-009-p0-rereview APPROVED, feature-016-p0-rereview APPROVED, ptu-rule-120-rereview APPROVED). Smoke test PASSED. 3 follow-up tickets filed (refactoring-113, ptu-rule-131, refactoring-114).
