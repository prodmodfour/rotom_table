...
P0 implemented on branch `slave/2-dev-feature-025-1772664485`:

| Commit | Files | Description |
|--------|-------|-------------|
| 606aa351 | app/utils/visionRules.ts | Vision capability types, constants, pure functions |
| baac7899 | app/types/encounter.ts | Add visionState to Combatant interface |
| 18a34a03 | app/server/api/.../vision.post.ts | Vision toggle API endpoint |
| de11e05a | app/stores/encounter.ts | toggleVisionCapability store action |
