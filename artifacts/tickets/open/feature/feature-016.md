...
| 2026-03-02 | P2 implemented (Intercept Melee/Ranged, Disengage) | 93f0017f, b28f9ac2, ee7d9430, 329c550b, c2ebac70, d7ce2f76, 4acd3635, e2c202e9 | 4 new: intercept-melee.post.ts, intercept-ranged.post.ts, lineOfAttack.ts, InterceptPrompt.vue, disengage.post.ts. 5 modified: combatManeuvers.ts (Maneuver interface + Disengage + provokesAoO), combat.ts (INTERCEPT_BLOCKING_CONDITIONS), character.ts (loyalty field), out-of-turn.service.ts (Intercept detection + resolution), useGridMovement.ts (Disengage 1m clamp), encounter.ts store (Intercept/Disengage actions + getters). Covers R116, R117, ptu-rule-095. |
| 2026-03-02 | P2 fix cycle (code-review-273 + rules-review-249) | 43d0caaa, a973b6ae, 6079c33f, 47e93d0b, d41b75b9, 37fea17f, 04915097, 327c2c02 | CRIT-001: canIntercept &&→|| Full Action check. HIGH-001: PTU alternating diagonal in failure step loops. HIGH-002: ptuDistanceTokensBBox for multi-tile distance (detection, DC, InterceptPrompt, lineOfAttack). HIGH-003: extracted intercept.service.ts (752+732 lines from 1420). rules-HIGH-001: getCombatantSpeed applies Stuck/Tripped/Slowed/Speed CS/Sprint modifiers. MED-001: actionId required in intercept-ranged. MED-002: Bad Sleep rationale comments. MED-003: InterceptPrompt targetSquare in ranged emit. app-surface.md updated. Files: out-of-turn.service.ts, intercept.service.ts (new), lineOfAttack.ts, InterceptPrompt.vue, intercept-ranged.post.ts, combat.ts, app-surface.md |
