...
| 2026-03-02 | P2 implemented | 2 commits (142bcc25, ade82061): PlayerHealingPanel.vue (breather + healing item tabs), wired into PlayerCombatActions.vue (Heal button, PhHeart icon, --heal SCSS variant, closes on turn end) |
| 2026-03-02 | P2 fix cycle | 4 commits (ecffe372..79e3f1f6): HIGH-1 app-surface.md updated with PlayerHealingPanel, HIGH-2 mutual exclusion between request panels via closeAllPanels/togglePanel, MED-1 cancel button added to PlayerHealingPanel, MED-2 redundant hp<=0 condition removed from healTargets |
