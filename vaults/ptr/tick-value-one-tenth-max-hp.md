A "tick" of Hit Points equals 1/10th of max HP, rounded down per [[always-round-down]]. This is an atomic unit referenced by burn damage, poison damage, cursed damage, bad sleep damage, and rest healing.
