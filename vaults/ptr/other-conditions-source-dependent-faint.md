Other category conditions (Stuck, Slowed, Trapped, Tripped, Vulnerable) have `clearsOnFaint: false` as the static default, matching PTU p.248's explicit mention of only Persistent and Volatile conditions.
