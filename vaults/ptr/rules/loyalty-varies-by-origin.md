...
This follows [[origin-dependent-defaults]] rather than a single universal default. At low loyalty, [[loyalty-command-check-dcs]] apply in battle. Loyalty is [[loyalty-is-visible|visible to both player and GM]].
