...
The scale: x1–x1.5 (insignificant), x2–x3 (everyday), x4–x5 (significant — gym leaders, rival battles, tournaments). Additional [[difficulty-adjusts-significance]] of ±x0.5–x1.5 can apply based on combat threat independent of narrative weight.

## See also

- [[encounter-xp-formula]]
- [[significance-scales-moveset-quality]]
