...
When the rules specifies a minimum duration for a mechanic ("at least 4 continuous hours"), the app accepts the actual duration rather than assuming the minimum. GM-specified durations are preferred over fixed defaults for time-based mechanics.
