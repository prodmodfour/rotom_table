When the rules defines different defaults based on a Pokemon's origin, the app implements origin-dependent behavior rather than collapsing to a single universal default.
