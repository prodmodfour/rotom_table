Swallow is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Normal"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "Self"`.
...
As a Status move, Swallow skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
