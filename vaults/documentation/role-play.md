Role Play is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Psychic"`, `damageBase: null`, `frequency: "Daily"`, `ac: null`, `range: "Melee, 1 Target"`.
...
As a Status move, Role Play skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
