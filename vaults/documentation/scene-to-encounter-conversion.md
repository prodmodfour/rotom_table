...
2. `StartEncounterModal.vue` opens — shows entity counts, encounter budget difficulty, lets GM choose battle type ([[battle-modes|Full Contact or Trainer League]]) and significance tier (scales XP per PTU Core p.460).
