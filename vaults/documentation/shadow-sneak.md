Shadow Sneak is stored in [[movedata-reference-table]] with `damageClass: "Physical"`, `type: "Ghost"`, `damageBase: 4`, `frequency: "At-Will"`, `ac: 2`, `range: "Melee, 1 Target, Priority"`.
