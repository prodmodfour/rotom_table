Jungle Healing is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Grass"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "Burst 1"`.
...
As a Status move, Jungle Healing skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
