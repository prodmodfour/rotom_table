...
The [[pathfinding-algorithm]] computes the path, and the server checks it against movement traits and the attack of opportunity system before committing the move.
