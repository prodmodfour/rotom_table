...
- [[combatant-interface-bloat]] — consumers pull 30+ fields from Combatant and compute externally, rather than telling the Combatant what to calculate
- [[player-action-request-optionals]] — callers inspect 20 optional fields and decide behavior, rather than the request object encapsulating its own validation
