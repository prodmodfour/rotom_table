Slack Off is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Normal"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "Self, Healing"`.
...
As a Status move, Slack Off skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
