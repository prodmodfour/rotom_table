Pain Split is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Normal"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "4, 1 Target"`.
...
As a Status move, Pain Split skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
