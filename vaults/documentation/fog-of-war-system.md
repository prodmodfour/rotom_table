...
State is persisted via dedicated fog GET/PUT endpoints on the encounter (see vtt grid persistence apis). The debounced save pattern prevents excessive API calls during brush painting.
