...
The GM retains control of the shared display per [[the-table-as-shared-space]], but each player's phone should show them what their own token can reach.

## See also

- [[information-asymmetry-by-role]] — grid tools must respect visibility filtering
- [[one-distance-metric-everywhere]] — player measurement tools use the same metric as GM tools
