...
- GM activates scene via [[scene-activation-lifecycle]] — BroadcastChannel notifies Group tab
...
- Group View `SceneView.vue` renders weather-themed backgrounds and CSS particle overlays for all 9 weather types
