Astral Barrage is stored in [[movedata-reference-table]] with `damageClass: "Special"`, `type: "Ghost"`, `damageBase: 12`, `frequency: "Daily"`, `ac: 2`, `range: "8, Ranged Blast 2, Smite Friendly"`.
...
Astral Barrage flows through the standard [[damage-flow-pipeline]] with DB 12 as the base. The [[nine-step-damage-formula]] applies STAB for Ghost-type users and type effectiveness. An accuracy roll against AC 2 is required via the [[evasion-and-accuracy-system]].
