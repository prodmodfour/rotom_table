Close Combat is stored in [[movedata-reference-table]] with `damageClass: "Physical"`, `type: "Fighting"`, `damageBase: 12`, `frequency: "Scene x2"`, `ac: 2`, `range: "Melee, 1 Target, Dash"`.
