Moonlight is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Fairy"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "Self, Healing"`.
...
As a Status move, Moonlight skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
