Arm Thrust is stored in [[movedata-reference-table]] with `damageClass: "Physical"`, `type: "Fighting"`, `damageBase: 2`, `frequency: "EOT"`, `ac: 4`, `range: "Melee, 1 Target, Five Strike"`.
