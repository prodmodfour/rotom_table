Sheer Cold is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Ice"`, `damageBase: null`, `frequency: "Daily"`, `ac: null`, `range: "4, 1 Target, Execute"`.
...
As a Status move, Sheer Cold skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
