# PTR Movement Rules in VTT

The [[vtt-rendering-pipeline|VTT grid code]] enforces these PTR rules (referenced by decree IDs):
...
- **Cone width** (decree-007): PTR cone shape geometry
...
- [[combatant-movement-capabilities]] — fly/swim/burrow movement trait queries
