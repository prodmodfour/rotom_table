A streamlined UI workflow for allocating trainer combat stats during level-up. The app presents the available points and valid allocation targets, validates against PTR constraints, and applies changes in one step.
