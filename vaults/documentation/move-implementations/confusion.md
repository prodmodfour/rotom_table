Confusion is stored in [[movedata-reference-table]] with `damageClass: "Special"`, `type: "Psychic"`, `damageBase: 5`, `energyCost: 2`, `ac: 2`, `range: "6, 1 Target"`.
...
Confusion Confuses the target on 19+. Confusion follows the [[confused-three-outcome-save]] resolution.
