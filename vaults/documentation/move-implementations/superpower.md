Superpower is stored in [[movedata-reference-table]] with `damageClass: "Physical"`, `type: "Fighting"`, `damageBase: 12`, `energyCost: 4`, `ac: 2`, `range: "Melee, 1 Target, Dash"`.
...
Superpower lowers the user's Attack and Defense by 1 Combat Stage each per the [[combat-stage-system]].
