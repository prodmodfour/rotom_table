Metal Sound is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Steel"`, `damageBase: null`, `energyCost: 1`, `ac: 4`, `range: "Burst 2, Friendly, Sonic"`.
...
All legal targets have their Special Defense lowered 2 Combat Stages per the [[combat-stage-system]].
