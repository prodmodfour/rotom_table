Overheat is stored in [[movedata-reference-table]] with `damageClass: "Special"`, `type: "Fire"`, `damageBase: 13`, `energyCost: 7`, `ac: 4`, `range: "8, Ranged Blast 3, Smite"`.
...
Lowers the user's Special Attack 2 Combat Stages after damage per the [[combat-stage-system]].
