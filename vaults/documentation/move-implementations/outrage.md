Outrage is stored in [[movedata-reference-table]] with `damageClass: "Physical"`, `type: "Dragon"`, `damageBase: 12`, `energyCost: 4`, `ac: 3`, `range: "Melee, All Adjacent Foes, Smite"`.
