...
- [[singleton-models]] — the app's GroupViewState and AppSettings use hardcoded singleton IDs in Prisma
...
- [[composable-store-direct-coupling]] — Pinia stores as singletons creating hidden coupling in composables
- [[ioc-container-architecture]] — a destructive proposal to replace singletons with an IoC container
- [[singleton-state-coupling]] — how the singleton pattern creates invisible coupling across the app
