Sketch is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Normal"`, `damageBase: null`, `frequency: "Daily"`, `ac: null`, `range: "15, 1 Target"`.
...
As a Status move, Sketch skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
