Heart Swap is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Psychic"`, `damageBase: null`, `frequency: "Daily"`, `ac: null`, `range: "10, 2 Targets"`.
...
As a Status move, Heart Swap skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
