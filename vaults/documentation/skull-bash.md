Skull Bash is stored in [[movedata-reference-table]] with `damageClass: "Physical"`, `type: "Normal"`, `damageBase: 13`, `frequency: "Scene x2"`, `ac: 2`, `range: "Melee, 1 Target, Dash, Push, Set-Up"`.
