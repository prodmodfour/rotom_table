Shore Up is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Ground"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "Self"`.
...
As a Status move, Shore Up skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
