Life Dew is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Water"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "Burst 1, Healing"`.
...
As a Status move, Life Dew skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
