Spotlight is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Normal"`, `damageBase: null`, `frequency: "Daily"`, `ac: null`, `range: "6, 1 Target, Priority"`.
...
As a Status move, Spotlight skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).

## Timing

Spotlight has the Priority keyword, placing it in the [[hold-priority-interrupt-system|Priority Window]] before normal actions.
