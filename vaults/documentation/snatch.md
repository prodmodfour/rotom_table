Snatch is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Dark"`, `damageBase: null`, `frequency: "Scene x2"`, `ac: null`, `range: "6, 1 Target, Trigger, Interrupt"`.
