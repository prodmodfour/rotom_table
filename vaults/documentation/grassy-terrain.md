Grassy Terrain is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Grass"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "Field"`.
...
As a Status move, Grassy Terrain skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
