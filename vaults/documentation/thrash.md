Thrash is stored in [[movedata-reference-table]] with `damageClass: "Physical"`, `type: "Normal"`, `damageBase: 12`, `frequency: "Scene x2"`, `ac: 3`, `range: "Melee, all adjacent foes, Smite"`.
