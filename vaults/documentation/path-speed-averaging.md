...
This is [[automate-routine-bookkeeping]] applied to movement — the GM does not manually compute mixed-terrain costs. The [[pathfinding-algorithm]] evaluates each tile's [[movement-modifiers-utility|movement modifier]] and produces a total cost for the path.
