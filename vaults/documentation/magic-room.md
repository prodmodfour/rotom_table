Magic Room is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Psychic"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "Field"`.
...
As a Status move, Magic Room skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
