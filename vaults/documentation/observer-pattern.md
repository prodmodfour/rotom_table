...
- [[websocket-real-time-sync]] — the app's WebSocket system is an Observer-like architecture: the server broadcasts events to subscribed clients
- [[websocket-sync-as-observer-pattern]] — the WebSocket system as an observer implementation
- [[event-sourced-encounter-state]] — a destructive proposal where clients subscribe to an event stream rather than receiving full state broadcasts
