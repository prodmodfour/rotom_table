Wide Guard is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Rock"`, `damageBase: null`, `frequency: "Scene"`, `ac: null`, `range: "Burst 1, Interrupt, Shield, Trigger"`.
