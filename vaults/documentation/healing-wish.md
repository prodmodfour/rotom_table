Healing Wish is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Psychic"`, `damageBase: null`, `frequency: "Daily"`, `ac: null`, `range: "6, 1 Target, Healing"`.
...
As a Status move, Healing Wish skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
