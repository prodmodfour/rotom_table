Discharge is stored in [[movedata-reference-table]] with `damageClass: "Special"`, `type: "Electric"`, `damageBase: 8`, `frequency: "EOT"`, `ac: 2`, `range: "All Cardinally Adjacent Targets"`.
