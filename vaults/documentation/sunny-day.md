Sunny Day is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Fire"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "Field, Weather"`.
...
As a Status move, Sunny Day skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
