Horn Drill is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Normal"`, `damageBase: null`, `frequency: "Daily"`, `ac: null`, `range: "Melee, 1 Target, Execute"`.
...
As a Status move, Horn Drill skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
