Prismatic Laser is stored in [[movedata-reference-table]] with `damageClass: "Special"`, `type: "Psychic"`, `damageBase: 16`, `frequency: "Daily x2"`, `ac: 4`, `range: "Line 8, Smite, Exhaust"`.
...
Prismatic Laser flows through the standard [[damage-flow-pipeline]] with DB 16 as the base. The [[nine-step-damage-formula]] applies STAB for Psychic-type users and type effectiveness. An accuracy roll against AC 4 is required via the [[evasion-and-accuracy-system]].
