Sandstorm is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Rock"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "Field, Weather"`.
...
As a Status move, Sandstorm skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
