Self-Destruct is stored in [[movedata-reference-table]] with `damageClass: "Physical"`, `type: "Normal"`, `damageBase: 20`, `frequency: "Daily"`, `ac: 2`, `range: "Burst 3"`.
...
Self-Destruct flows through the standard [[damage-flow-pipeline]] with DB 20 as the base. The [[nine-step-damage-formula]] applies STAB for Normal-type users and type effectiveness. An accuracy roll against AC 2 is required via the [[evasion-and-accuracy-system]].
