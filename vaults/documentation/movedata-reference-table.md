...
The table is derived from the [[moves-csv-source-file]] and drives the [[damage-flow-pipeline]], [[evasion-and-accuracy-system]], and [[move-frequency-system]]. The damageBase feeds into the [[nine-step-damage-formula]], while ac and evasion interact through the [[evasion-and-accuracy-system]].
...
- [[move-frequency-system]] — consumes frequency values
