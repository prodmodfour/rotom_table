Lunar Blessing is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Psychic"`, `damageBase: null`, `frequency: "Daily"`, `ac: null`, `range: "Self"`.
...
As a Status move, Lunar Blessing skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
