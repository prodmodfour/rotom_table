High Jump Kick is stored in [[movedata-reference-table]] with `damageClass: "Physical"`, `type: "Fighting"`, `damageBase: 13`, `frequency: "EOT"`, `ac: 3`, `range: "Melee, Dash, 1 Target"`.
