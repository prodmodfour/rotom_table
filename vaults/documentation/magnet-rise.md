Magnet Rise is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Electric"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "Self, Swift Action"`.
...
As a Status move, Magnet Rise skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
