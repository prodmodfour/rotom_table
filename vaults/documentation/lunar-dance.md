Lunar Dance is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Psychic"`, `damageBase: null`, `frequency: "Daily"`, `ac: null`, `range: "8"`.
...
As a Status move, Lunar Dance skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
