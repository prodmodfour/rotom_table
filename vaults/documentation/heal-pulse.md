Heal Pulse is stored in [[movedata-reference-table]] with `damageClass: "Status"`, `type: "Psychic"`, `damageBase: null`, `frequency: "Daily x2"`, `ac: null`, `range: "6, 1 Target, Aura, Healing"`.
...
As a Status move, Heal Pulse skips the [[damage-flow-pipeline]]. No accuracy roll is needed (AC is null).
